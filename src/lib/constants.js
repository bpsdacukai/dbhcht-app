...
export const PROGRAM_BY_BIDANG = {
  kesmas: ['Program Peningkatan Kualitas Bahan Baku','Program Pembinaan Industri','Program Pembinaan Lingkungan Sosial'],
  kesehatan: ['Pelayanan Kesehatan Promotif/Preventif/Kuratif','Penyediaan/Peningkatan Sarana/Prasarana Fasilitas Kesehatan','Penyediaan Sarana Sanitasi, Pengelolaan Limbah & Air Bersih','Pembayaran Iuran Jaminan Kesehatan'],
  hukum: ['Program Pembinaan Industri','Program Sosialisasi Ketentuan di Bidang Cukai','Program Pemberantasan BKC Ilegal'],
  koordinasi: ['Kegiatan Koordinasi Pengelolaan DBH CHT','Kegiatan Pendukung Pengelolaan DBH CHT'],
}
...
export const SUB_KEGIATAN_KOORDINASI = [
  ...
  'Penyusunan RKP DBH CHT','Monitoring dan Evaluasi Penggunaan DBH CHT',
  'Pelaporan Penggunaan DBH CHT','Administrasi dan Dukungan Operasional Tim Koordinasi',
]
...
export const KODE_REKENING_BY_BIDANG = {
  kesmas: [
    ...
    { kode:'3.27.05.2.01.0001', nama:'Pengendalian Organisme Pengganggu Tumbuhan (OPT) Tanaman Pangan, Hortikultura dan Perkebunan' },
    ...
    { kode:'3.27.02.2.01.0001', nama:'Pengawasan Penggunaan Sarana Pendukung Pertanian Sesuai Komoditas, Teknologi dan Spesifik Lokasi' },
    ...
    { kode:'3.31.02.2.01.0005', nama:'Koordinasi, Sinkronisasi, dan Pelaksanaan Pemberdayaan Industri dan Peran Serta Masyarakat' },
    ...
    { kode:'2.07.05.2.02.0005', nama:'Pengembangan Pelaksanaan Jaminan Sosial Tenaga Kerja dan Fasilitas Kesejahteraan Pekerja' },
  ...
  kesehatan: [
    ...
    { kode:'1.02.02.2.01.0023', nama:'Pengadaan Obat, Bahan Habis Pakai, Vaksin, Makanan dan Minuman di Fasilitas Kesehatan' },
